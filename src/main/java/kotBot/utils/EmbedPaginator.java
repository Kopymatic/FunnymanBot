//STOLEN FROM https://github.com/Andre601/JDA-Utilities/blob/c45ea7cff1ad3d7780feb9194032bad08f26e0f9/menu/src/main/java/com/jagrosh/jdautilities/menu/EmbedPaginator.java
...
public class EmbedPaginator extends Menu {
     ...
     * in the provided {@link MessageChannel MessageChannel}, starting
    ...
    public static class Builder extends Menu.Builder<Builder, EmbedPaginator> {
         ...
         *
         * @param allowTextInput {@code true} if the EmbedPaginator will allow page-number text input.
         * @return This builder
         */
         ...
         * {@link GuildChannel GuildChannel} the menu is displayed in.
         *
         ...
         *
         * @param left  The left text input, causes the EmbedPaginator to traverse one page left.
         * @param right The right text input, causes the EmbedPaginator to traverse one page right.
         * @return This builder
         */
