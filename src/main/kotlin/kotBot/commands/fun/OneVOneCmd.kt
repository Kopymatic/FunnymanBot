...
class OneVOneCmd : KopyCommand() {
    ...
    private val descriptors = arrayOf(
        "a little too hard",
        "with a poke",
        "by throwing a grand piano at them",
        "using a S&W Model 460 XVR Magnum",
        "with a Railgun",
        "with a george foreman grill",
        "using a Cheytac M200 Intervention Sniper Rifle",
        "using a salt cannon",
        "just by their sheer swagness",
        "using a lightsaber",
        "by throwing 9001 fedoras at them",
        "by tipping their fedora too hard",
        "by posting cringe",
        "by posting nsfw in general",
        "by slamming a fridge door at the speed of light on their face",
        "using a donut",
        "with a bowling ball",
        "with a poke",
        "with a broom",
        "with their dank memes",
        "by poking them with a bullet at the speed of sound",
        "using a watering hose",
        "using a billion airhorns",
        "by launching 50 nukes taped together at them",
        "using their  m a g n u m   d o n g",
        "using their dump truck ass",
        "using their absolutely massive tiddies",
        "with covid-19",
        "with measles",
        "with boredom",
        "by taking their phone",
        "by saying it was their turn on the xbox",
